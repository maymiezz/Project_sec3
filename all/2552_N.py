import pygal
"""show graph of income of thai population in 2552 north"""
def north_2552():
    """show graph that use data from dic in 2552 north"""
    dic = {
        'ภาคกลาง': {
            'ฉะเชิงเทรา': {
                2552: 7040,
    ...
    height_ = 1000
    width_ = 1000
    html_f_name = '2552_N.html'
    svg_f_name= '2552_N.svg'
    line_chart = pygal.HorizontalBar(height=height_, width=width_)
    line_chart.title = 'สถิติรายได้ของประชากรภาคเหนือในปี 2552'
    for i in dic['ภาคเหนือ']:
        line_chart.add(i, dic['ภาคเหนือ'][i][2552])
