import pygal
"""Line chart income of central part in 2547"""
def line_chart2547():
    """Show Line chart income of central part in 2547"""
    dic = {
        'ภาคกลาง': {
            'ฉะเชิงเทรา': {
                2552: 7040,
    ...
    height_ = 1000
    width_ = 1000
    html_f_name = '2547_C.html'
    svg_f_name= '2547_C.svg'
    line_chart = pygal.HorizontalBar(height=height_, width=width_)
    line_chart.title = 'สถิติรายได้ของประชากรภาคกลางในปี 2547'
    for i in dic['ภาคกลาง']:
                line_chart.add(i, dic['ภาคกลาง'][i][2547])
