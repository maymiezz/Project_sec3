import pygal
"""show graph of income of thai population in 2545"""
def neast_2545():
    """show graph that use data from dic in 2545"""
    dic = {
        'ภาคกลาง': {
            'ฉะเชิงเทรา': {
                2552: 7040,
    ...
    height_ = 1000
    width_ = 1000
    html_f_name = '2545_NE.html'
    svg_f_name= '2545_NE.svg'
    line_chart = pygal.HorizontalBar(height=height_, width=width_)
    line_chart.title = 'สถิติรายได้ของประชากรภาคตะวันออกเฉียงเหนือในปี 2545'
    for i in dic['ภาคตะวันออกเฉียงเหนือ']:
        line_chart.add(i, dic['ภาคตะวันออกเฉียงเหนือ'][i][2545])
