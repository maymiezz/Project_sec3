...
def line_chart(part, year):
    ...
    height_ = 1000
    width_ = 1000
    html_f_name = '2550_C.html'
    svg_f_name= '2550_C.svg'
    line_chart = pygal.HorizontalBar(height=height_, width=width_)
    line_chart.title = 'สถิติรายได้ของประชากรภาคกลางในปี 2550'
    for i in dic['ภาคกลาง']:
                line_chart.add(i, dic['ภาคกลาง'][i][2550])
